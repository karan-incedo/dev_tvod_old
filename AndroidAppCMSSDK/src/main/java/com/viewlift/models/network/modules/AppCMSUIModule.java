...
import com.viewlift.models.network.rest.AppCMSFilmRecordsRest;
...
public class AppCMSUIModule {
    ...
    public AppCMSUIModule(Context context, String baseUrl) {
    ...
    @Provides
    @Singleton
    public AppCMSFilmRecordsRest providesAppCMSFilmRecordsRest(Retrofit retrofit) {
        return retrofit.create(AppCMSFilmRecordsRest.class);
    }
    ...
    @Provides
    @Singleton
    public AppCMSFilmRecordsCall providesAppCMSFilmRecordsCall(AppCMSFilmRecordsRest appCMSFilmRecordsRest) {
        return new AppCMSFilmRecordsCall(appCMSFilmRecordsRest);
    }
