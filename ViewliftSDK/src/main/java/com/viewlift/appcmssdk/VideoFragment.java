...
public class VideoFragment extends Fragment
    ...
    public static VideoFragment newInstance(Context context,
                                                      ...
                                                      String hlsUrl,
                                                      String adsUrl) {
        VideoFragment appCMSPlayVideoFragment = new VideoFragment();
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        shouldRequestAds = !TextUtils.isEmpty(adsUrl);
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        videoPlayerInfoContainer = (ConstraintLayout) rootView.findViewById(R.id.app_cms_video_player_info_container);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        adsLoader.addAdsLoadedListener(new AdsLoader.AdsLoadedListener() {
            ...
            public void onAdsManagerLoaded(AdsManagerLoadedEvent adsManagerLoadedEvent) {
                ...
                adsManager.addAdErrorListener(VideoFragment.this);
                adsManager.addAdEventListener(VideoFragment.this);
                adsManager.init();
            }
        });
    }
