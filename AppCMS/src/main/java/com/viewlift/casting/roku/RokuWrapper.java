        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case APP_LAUNCH_MESSAGE_ID:
                    ...
                    try {
                        String tgcAppId = getTGCAppIdByParsingXMLResponse(getAllApps());
                        selectedRokuDevice.setRokuAppId(tgcAppId);
...
//        rokuDevices.clear();
    ...
    private void fetchAppIdIfNotExists(String strRokuAction) {
        String tgcAppId = null;
        if (selectedRokuDevice != null)
            tgcAppId = selectedRokuDevice.getRokuAppId();
        if (tgcAppId == null) {
    ...
    private String getTGCAppIdByParsingXMLResponse(String is) throws XmlPullParserException, IOException {
        ...
        new GetRokuDevicesAsyncTask(
                new Action1<String>() {
                    ...
                    public void call(String responseRokuDevices) {
                        try {
                            selectedRokuDevice.setRokuAppId(getTGCAppIdByParsingXMLResponse(responseRokuDevices));
