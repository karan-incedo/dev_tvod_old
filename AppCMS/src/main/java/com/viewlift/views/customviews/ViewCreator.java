    ...
    public <T extends ModuleWithComponents> View createModuleView(final Context context,
        ...
        if (jsonValueKeyMap.get(module.getView()) == AppCMSUIKeyType.PAGE_AUTHENTICATION_MODULE_KEY) {
            ...
            if (modulesHasHiddenComponent) {
                for (int i = 0; i < module.getComponents().size(); i++) {
                    Component childComponent = module.getComponents().get(i);
                ...
                if (moduleType == AppCMSUIKeyType.PAGE_DOWNLOAD_SETTING_MODULE_KEY) {
                    ...
                    ((RecyclerView) componentViewResult.componentView)
                            .setLayoutManager(new LinearLayoutManager(context,
                                    ...
                                    false));
                    List<Mpeg> mpegs = moduleAPI.getContentData().get(0).getStreamingInfo().getVideoAssets().getMpeg();
                    ...
                    ((RecyclerView) componentViewResult.componentView).setId(R.id.download_quality_selection_list);
            ...
            case PAGE_BUTTON_KEY:
                ...
                switch (componentKey) {
                    ...
                    case PAGE_AUTOPLAY_MOVIE_CANCEL_BUTTON_KEY:
                        ...
                        break;
                    case PAGE_DOWNLOAD_QUALITY_CCONTINUE_BUTTON_KEY:
